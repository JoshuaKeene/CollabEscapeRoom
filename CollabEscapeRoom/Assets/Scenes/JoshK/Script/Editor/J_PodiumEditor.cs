...
[CustomEditor(typeof(J_Interactive_Podium))]
[CanEditMultipleObjects]
public class J_PodiumEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        //Modification - Josh K
        var PodiumScript = target as J_Interactive_Podium;
        if (PodiumScript.Type == J_Interactive_Podium.TypeEnum.One)
        {
        ...
        if (PodiumScript.Type == J_Interactive_Podium.TypeEnum.Two)
        {
            if (GUILayout.Button("Reset"))
            {
