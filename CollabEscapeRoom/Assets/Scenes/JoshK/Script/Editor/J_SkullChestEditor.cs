...
[CustomEditor(typeof(J_Interactive_SkullLock))]
[CanEditMultipleObjects]
public class J_SkullChestEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        var SkullLockScript = target as J_Interactive_SkullLock;
        //Create the needed variables
        SkullLockScript.AssignVariables();
        SkullLockScript.CreateLists();
        //Is the chest in Advanced or Standard state?
        if (SkullLockScript.Type == J_Interactive_SkullLock.ChestTypeEnum.Standard && IsStandard == false)
        {
        ...
        if (SkullLockScript.Type == J_Interactive_SkullLock.ChestTypeEnum.Advanced && IsAdvanced == false)
        {
            SkullLockScript.SwitchChestType();
            //Store the state
            IsAdvanced = true;
