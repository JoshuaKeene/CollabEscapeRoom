...
{
    public static J_AudioManager GlobalSFXManager;
    [Header("AudioEmitter")]
    ...
    {
        StartCoroutine(J_AudioManager.GlobalSFXManager.FadeIn(J_UIManager.TheUI.MainCanvas.GetComponent<AudioSource>(), 2));
    }

    public void CreditsMusicEnd()
    {
        StartCoroutine(J_AudioManager.GlobalSFXManager.FadeOut(J_UIManager.TheUI.MainCanvas.GetComponent<AudioSource>(), 4));
    }
}
